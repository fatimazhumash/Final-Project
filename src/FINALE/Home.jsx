    ...
    <div className="home">
      ...
      <section className="home-section">
        ...
        <div className="card-list">
          ...
          <div className="card">
            <img src="https://avatars.mds.yandex.net/i?id=aa0bff02f4f5f4abdb82f8c31dbfe152b95d1ac5-12537955-images-thumbs&n=13" alt="SpongeBob" />
            <p>SpongeBob SquarePants</p>
          </div>
          <div className="card">
            <img src="https://avatars.mds.yandex.net/i?id=23db8d9fdff823e2c40f3fc4a4504969dcb3da23-12537956-images-thumbs&n=13" alt="Frozen" />
            <p>Frozen</p>
          </div>
        </div>
      </section>
      ...
      <section className="home-section">
        ...
        <div className="card-list">
          ...
          <div className="card">
            <img src="https://avatars.mds.yandex.net/i?id=9ff4f08a71de5ef0970b4f7a255e1a60195b40f2-5236154-images-thumbs&n=13" alt="Perfect" />
            <p>Ed Sheeran - Perfect</p>
          </div>
          <div className="card">
            <img src="https://avatars.mds.yandex.net/i?id=2af243eb3d9e4dd2cda5f9b38787cd876ad6f7c5-12537957-images-thumbs&n=13" alt="Someone Like You" />
